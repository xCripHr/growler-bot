  ...
  if (command === "sunucu-kurulum") {
    ...
    message.channel
      ...
      .then(collected => {
        ...
        message.guild.owner.send(
          "Gerekli Herşey Kuruldu Rahatına Bak! **HAN  Bot'un kıymetini bil :D**"
        );
      });
  }
});
